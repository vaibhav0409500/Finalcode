...
public class TestBase {
	...
	public static void initialization(){
		...
		if(browserName.equals("chrome")){
			...
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\vaibhavkhare\\eclipse-workspace\\Assignment\\src\\main\\resources\\chromedriver.exe");	
			driver = new ChromeDriver(); 
		}
		else if(browserName.equals("FF")){
			System.setProperty("webdriver.gecko.driver", "C:\\Users\\vaibhavkhare\\Downloads\\geckodriver.exe");	
